...
typedef struct hiPHOTO_HDR_COEF_S
{
    ...
    HI_U32      u32BlendCenter;
    HI_FLOAT    f32BlendSigma;
    HI_S32      s32AjustRatio;
    HI_S32      as32DetailEnhanceRatio[2];
...
typedef struct hiPHOTO_MFNR_GHOST_DETECTION_S
{
    HI_S32 s32LumaThreshLow;
    HI_S32 s32LumaThreshHigh;
    HI_S32 s32LumaNoiseThresh;
    HI_S32 s32ChromaThreshLow;
}PHOTO_MFNR_GHOST_DETECTION_S;
...
typedef struct hiPHOTO_MFNR_3DNR_ISO_STRATEGY_S
{
    ...
    PHOTO_MFNR_GHOST_DETECTION_S    stGhostDetection;
...
__inline static HI_U32 HDR_GetPublicMemSize(HI_U32 u32Width, HI_U32 u32Height)
{
    ...
    HI_U32 u32PubMemSize = u32Stride * u32Height * 16.9 + 6000000;
...
{
    HI_U32 u32Stride = ALIGN_UP(u32Width, 128);
    HI_U32 u32PubMemSize = u32Stride * u32Height * 11.5 + 6000000;
