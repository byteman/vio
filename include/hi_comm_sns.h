...
typedef struct hiISP_CMOS_DRC_S
{
    ...
    //Traditional Curve Related Parameters
    HI_U8   u8Asymmetry;
    HI_U8   u8SecondPole;
    HI_U8   u8Stretch;
    HI_U8   u8Compress;

    //Cubic curve method related parameters
    HI_U8   u8CurveSel;

    //HI_U16  u16CubicThres[3];
    //HI_U32  au32CubicCoef0[7];
    //HI_U32  au32CubicCoef1[7];
    //HI_U32  au32CubicCoef2[7];
    //HI_U32  au32CubicCoef3[7];
...
typedef struct hiISP_CMOS_SPLIT_S
{
    ...
    ISP_CMOS_SPLIT_POINT_S astSplitPoint[5];
} ISP_CMOS_SPLIT_S;
