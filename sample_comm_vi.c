...
HI_S32  SAMPLE_COMM_VI_SwitchMode(SAMPLE_VI_CONFIG_S* pstViConfigDes)
{
   ...
   HI_S32              s32Ret = HI_SUCCESS;
    ...
    s32Ret = SAMPLE_COMM_VI_CreateVi(pstViConfigDes);
...
HI_VOID SAMPLE_COMM_VI_GetSensorInfo(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    pstViConfig->astViInfo[0].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[1].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[2].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[3].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[4].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[5].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[6].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
    pstViConfig->astViInfo[7].stSnsInfo.enSnsType = SONY_IMX477_MIPI_8M_30FPS_12BIT;
}
